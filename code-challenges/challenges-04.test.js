...
const addTwo = (arr) => {
    // Solution code here...
    let newArray = [];
    arr.forEach((value, index) => newArray[index] = value + 2);
    return newArray;
...
const containsW = (str) => {
    ...
    let newstring = '';
    let regex = /[w]/;
    let answer = regex.test(newstring);
    return answer;
};
...
const isNum = (input) => {
    let newInput = '';
    let regex = /\d/;
    let answer = regex.test(newInput);
    return answer;
    // Solution code here...
};
...
const containsWorld = (input) => {
    // Solution code here...
    let newWord;
    let regex = /\b(\w*world\w*)\b/g;
    let answer = regex.test(newWord);
    return answer;
};
...
const isCapitalized = (str) => {
    ...
    let newString = '';
    let regex = /\b[A-Z].*?\b/g;
    let answer = newString.match(regex);
    return answer;
};
